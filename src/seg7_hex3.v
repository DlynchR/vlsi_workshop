...
module seg7_hex3 #(
    ...
    localparam TICKS_PER_DIGIT = CLK_HZ / (REFRESH_PER_DIGIT_HZ * 3);
    localparam CNT_W = (TICKS_PER_DIGIT <= 2) ? 1 : $clog2(TICKS_PER_DIGIT);
    ...
    // Decoder HEX a 7 segmentos. Orden: seg[6:0] = a b c d e f g. Activo en bajo
    always @* begin
